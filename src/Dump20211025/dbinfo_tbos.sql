...
CREATE TABLE `tbos` (
  ...
  `mecanico` varchar(30) DEFAULT NULL,
  `valorini` decimal(10,2) DEFAULT NULL,
  `idcli` int NOT NULL,
  PRIMARY KEY (`os`),
  KEY `idcli` (`idcli`),
...
INSERT INTO `tbos` VALUES (1,'2021-10-26 01:01:20','BMW','320i','Lanterna esquerda quebrada','neguinho',320.90,1);
...
-- Dump completed on 2021-10-25 22:48:02
